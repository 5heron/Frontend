    ...
    return (
        <div className="bg-gradient-to-r from-indigo-950 via-violet-950 to-purple-950 h-full py-10">
            ...
            <div className="max-w-lg mx-auto text-center pt-[75px]">
                <h2 className="text-2xl font-bold mb-4  bg-gradient-to-r from-green-200 to-rose-700 p-8 text-transparent bg-clip-text">Screen-3 Booking</h2>
